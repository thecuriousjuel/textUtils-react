        ...
        <div className='container' style={props.mode}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" style={props.mode} data-bs-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" style={props.mode} data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" style={props.mode} data-bs-parent="#accordionExample" >
                        <div className="accordion-body">
